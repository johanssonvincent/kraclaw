...
type Orchestrator struct {
	...
	// prevLast* fields (PERF-04) are a best-effort dedup optimisation: compared a...
...
func (o *Orchestrator) processGroupMessages(ctx context.Context, chatJID string, releaseSlot func()) (bool, error) {
	...
	// Enforce MAX_CONCURRENT limit — reject sandbox creation when at capacity (RE...
...
// sandboxWatcher runs a self-healing loop that subscribes to Sandbox lifecycl...
...
// watchGroupOutput subscribes to IPC output for a single group and processes ...
